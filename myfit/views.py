...
class ProfileUpdateView(generic.UpdateView):
        ...
        def get_queryset(self):
            #I define a queryset to make sure the user who is logged in is retrieving his own information.
            #Without doing this a user who is logged in can change the id in the url and retrieve the information of another user!!
            return Device_Owner.objects.filter(user = self.request.user)
...
def upload_activities_view(request):
    ...
    if p.is_dir():
        ...
        error_message.append('The path saved in the user profile is NOT valid.')
