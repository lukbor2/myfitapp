...
class Device_OwnerAdmin(admin.ModelAdmin):
    fields = ('name', 'surname', 'date_of_birth', 'age', 'sex', 'height','weight', 'heart_rate_max','heart_rate_rest', 'user')
    list_display = ('name', 'surname', 'date_of_birth', 'age', 'sex', 'height', 'weight', 'heart_rate_max', 'heart_rate_rest', 'user')
