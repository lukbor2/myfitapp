"""
Django settings for myfitapp project.
...
SECRET_KEY = '3+f7er-mf8n&sky8-ix+s%lr@_n0)@avq-*3(i)e)klgluu0$9'
...
ALLOWED_HOSTS = ['myfitapp-lukbor2.c9users.io',
                 '127.0.0.1',
                 '16251d9ea95945399d8946a96db75c67.vfs.cloud9.us-east-1.amazonaws.com',]
...
WSGI_APPLICATION = 'myfitapp.wsgi.application'
